                ...
                <form id="registrationForm" class="w-full flex flex-col justify-center items-start gap-12" method="POST"
                    ...
                    <div class="w-full flex gap-4 sm:gap-6">
                        <h1 id="progress-indicator1"
                            class="w-10 h-10 text-indigo-600 font-bold rounded-full p-2 text-center ring-1 ring-indigo-500">
                            1
                        </h1>
                            ...
                            <div class="flex flex-col gap-8 hidden" id="form-content3">
                                ...
                                <div class="flex flex-row w-full gap-2">
                                    ...
                                    <button
                                        ...
                                        class="flex-grow rounded-lg bg-indigo-600 text-white font-semibold p-2 box-border self-center"
                                        type="submit">Save
                                    </button>
                                </div>
                            </div>
    ...
    <script>
        ...
        function updateBtnNext3() {
            ...
            if (lat.innerHTML.length < 1 || long.innerHTML.length < 1 || cit.value.length < 3 && cont.value.length < 1 || address.value.length < 1 || postal.value.length < 1) {
                updateClasses("button-progress-3", ["!bg-gray-100", "text-gray-400"], ["bg-indigo-600", "text-white"]);
                ...
                updateClasses("button-progress-3", ["!bg-indigo-600", "text-white"], ["!bg-gray-100"]);
        ...
        function updateBtnNext2() {
            ...
            if (e.value.length > 5) {
                updateClasses("button-progress-2", ["bg-indigo-600", "text-white"], ["bg-gray-100"]);
        ...
        function updateBtnNext1() {
            ...
            if (e.value.startsWith(0) && e.value.length > 7) {
                updateClasses("button-progress-1", ["bg-indigo-600", "text-white"], ["bg-gray-100"]);
                document.getElementById("button-progress-1").removeAttribute("disabled")
            } else {
                updateClasses("button-progress-1", ["bg-gray-100", "text-gray-400"], ["bg-indigo-600", "text-white"]);
        ...
        function updateUI() {
            if (progress === 0) {
                ...
                updateClasses("progress-indicator2", ["ring-indigo-500"], []);
                updateClasses("progress-indicator3", ["text-white", "bg-gray-300"], ["ring-1"]);
                updateClasses("form-content1", ["hidden"], []);
                updateClasses("form-content2", [], ["hidden"]);
                updateClasses("form-content3", ["hidden"], []);
                ...
                updateClasses("progress-indicator1", ["bg-indigo-600", "text-white"], []);
                updateClasses("progress-indicator2", ["bg-indigo-600", "text-white"], []);
                updateSVG("progress-indicator1", svg);
                updateSVG("progress-indicator2", svg);
                updateClasses("progress-indicator3", ["ring-indigo-500"], []);
                updateClasses("form-content1", ["hidden"], []);
                updateClasses("form-content2", ["hidden"], []);
                updateClasses("form-content3", [], ["hidden"]);
            }

<div class="relative w-full p-10 box-border flex flex-col justify-between items-center gap-4">
    <h1 class="text-4xl text-indigo-500 font-bold self-start">Edit Product Variant</h1>
    ...
    <div class="w-full flex justify-end items-center gap-4">
        <button wire:loading.attr='disabled' wire:click='save'
            class="px-10 py-2 text-indigo-500 font-semibold ring-1 ring-indigo-500 rounded-md disabled:cursor-not-allowed">Cancel</button>
        <button wire:loading.attr='disabled' wire:click='save'
            class="px-10 py-2 text-white font-semibold bg-indigo-500 rounded-md disabled:cursor-not-allowed hover:bg-indigo-600">Save</button>
    </div>
</div>
